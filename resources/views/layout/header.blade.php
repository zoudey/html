...
<!-- Mirrored from demo.snstheme.com/html/simen/index3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Jul 2022 14:16:07 GMT -->
<!-- Added by HTTrack -->
        ...
        <div id="sns_header" class="wrap">
                                    ...
                                    <div id="sns_custommenu" class="visible-md visible-lg">
                                        <ul class="mainnav">
                                            <li class="level0 custom-item ">
                                                <a class="menu-title-lv0" href="/" target="_self">
                                                            ...
                                                            <ol id="cart-sidebar" class="mini-products-list">
                                                                <li class="item odd">
                                                                    <a class="product-image" title="Modular Modern"
                                                                        href="detail.html">
                                                                        <img alt=""
                                                                            src="{{ asset('/dist/images/products/1.jpg') }}">
                                                                    </a>
            ...
            <div id="sns_slideshows3">
                <div id="slishow_wrap12" class="sns-slideshow owl-carousel owl-theme owl-loaded">
                    <div class="item">
                        <img src="/dist/images/sildeshow/page3-2.jpg" alt="">
                    </div>
                    <div class="item">
                        <img src="/dist/images/sildeshow/page3-2.jpg" alt="">
                    </div>
